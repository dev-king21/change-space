<template>
  <v-container tag="footer" class="footer">
    <v-row>
        ...
        <v-row v-if="isDesktop" justify="space-around">
          ...
          >
            ...
            <v-row>
              ...
              <v-col v-if="footer.other_description">
                <ul>
                  <li
                    v-for="(item, index) in footer.other_description"
                    :key="index"
                  >
                    <nuxt-link :to="footer.other_link[index]">
                      {{ item }}
                    </nuxt-link>
                  </li>
                </ul>
      ...
      <v-col class="pa-4" md="12" cols="12">
    ...
    footers: [
      {
        ...
        other_description: ['Team', 'History', 'Contact us', 'Locations'],
        other_link: ['#team', '#history', '#contact-us', '#locations'],
      },
      {
        title: 'Resources',
        description: [
